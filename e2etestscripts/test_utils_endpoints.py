...
def test_validate_card_valid():
    """Test POST /api/v1/validate-card with valid agent card"""
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            if (data.get("is_valid") == True and 
                ...
                log_result(True, "POST", "/api/v1/validate-card (valid)")
            else:
                log_result(False, "POST", "/api/v1/validate-card (valid)", 
        ...
        log_result(False, "POST", "/api/v1/validate-card (valid)", str(e))

def test_validate_card_invalid():
    """Test POST /api/v1/validate-card with invalid agent card"""
    headers = {"Content-Type": "application/json"}
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            if (data.get("is_valid") == False and 
                "detail" in data):
                log_result(True, "POST", "/api/v1/validate-card (invalid)", 
                ...
                if data.get("detail", "").startswith("Validation skipped"):
                    ...
                    log_result(False, "POST", "/api/v1/validate-card (invalid)", 
        ...
        log_result(False, "POST", "/api/v1/validate-card (invalid)", str(e))

def test_validate_card_empty():
    """Test POST /api/v1/validate-card with empty card data"""
    headers = {"Content-Type": "application/json"}
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            if data.get("is_valid") == False:
                log_result(True, "POST", "/api/v1/validate-card (empty)", 
                          "Correctly rejected empty card")
            elif data.get("detail", "").startswith("Validation skipped"):
                log_result(True, "POST", "/api/v1/validate-card (empty)", 
                          "Validation skipped (library not available)")
            else:
                log_result(False, "POST", "/api/v1/validate-card (empty)", 
        ...
        log_result(False, "POST", "/api/v1/validate-card (empty)", str(e))

def test_validate_card_no_data():
    """Test POST /api/v1/validate-card without card_data field"""
    headers = {"Content-Type": "application/json"}
    ...
    try:
        ...
        if response.status_code == 422:
            log_result(True, "POST", "/api/v1/validate-card (no data)", 
                      "Correctly rejected missing card_data")
        else:
            log_result(False, "POST", "/api/v1/validate-card (no data)", 
                      f"Expected 422, got {response.status_code}")
            
    except Exception as e:
        log_result(False, "POST", "/api/v1/validate-card (no data)", str(e))
